...
public class Database {
    ...
    public Query sql(String sql, Object... args) {
        return new Query(this, transaction).sql(sql, args);
    }
    ...
    public Query where(String where, Object... args) {
        return new Query(this, transaction).where(where, args);
    }
    ...
    public Query orderBy(String orderBy) {
        return new Query(this, transaction).orderBy(orderBy);
    }
    ...
    public Query createTable(Class clazz) {
        return new Query(this, transaction).createTable(clazz);
    }
    ...
    public Query insert(Object row) {
        return new Query(this, transaction).insert(row);
    }
    ...
    public Query delete(Object row) {
        return new Query(this, transaction).delete(row);
    }
    ...
    public <T> List<T> results(Class<T> clazz) {
        return new Query(this, transaction).results(clazz);
    }
    ...
    public <T> T first(Class<T> clazz) {
        return new Query(this, transaction).first(clazz);
    }
    ...
    public Query update(Object row) {
        return new Query(this, transaction).update(row);
    }
    ...
    public Query upsert(Object row) {
        return new Query(this, transaction).upsert(row);
    }
    ...
    public Query table(String table) {
        return new Query(this, transaction).table(table);
    }
